              ...
              {chats.length > 0 && (
                <div className="flex justify-end mb-2">
                  <button
                    ...
                    className="flex items-center gap-2 text-red-400 hover:text-red-300 text-sm bg-red-500/10 px-4 py-2 rounded-lg hover:bg-red-500/20 transition-colors"
                  >
                    <FiTrash2 className="text-sm" /> Clear All Chats
                  </button>
                </div>
              )}
              {chats.length === 0 ? (
